      ...
      >
        <Toolbar className={classes.toolbar}>
          ...
          <div className={classes.menuItems}>
                ...
                <Button onClick={handleDrawerToggle} color="inherit" classes={{ root : classes.menuButton}} className={splitLocation[1] === "jblife" ? (scroll ? classes.activeScrolled: classes.active ) : ""}><Link classes={classes.menuLink} className={splitLocation[1] === "jblife" ? (scroll? classes.activeLinkScroll : classes.activeLink) : classes.menuLink}  to="/jblife">Life at JB </Link></Button>
